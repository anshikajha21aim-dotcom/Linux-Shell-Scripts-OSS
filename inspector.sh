...
case $PACKAGE in
    ...
    mysql-server)
        ...
        ;;
    firefox)
        echo "Philosophy: The browser that fights for a free and open web."
        ;;
    vlc)
        echo "Philosophy: The universal player that respects user freedom."
        ;;
    *)
        echo "Philosophy: A community-driven tool for the modern digital era."
        ;;
esac
echo "------------------------------------------"
